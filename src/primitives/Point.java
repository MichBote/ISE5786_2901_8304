...
public class Point {
    ...
    */
   public Point(double x, double y, double z) { this(new Double3(x, y, z)); }

   /**
    * Constructs a point from a {@link Double3} container.
    * @param xyz point coordinates
    */
   public Point(Double3 xyz) { xyz_ = xyz; }
    ...
    */
   public Vector subtract(Point other) { return new Vector(xyz_.subtract(other.xyz_)); }
    ...
    */
   public Point add(Vector vector) { return new Point(xyz_.add(vector.xyz_)); }
   ...
   @Override
   public int hashCode() { return Objects.hash(xyz_); }

   @Override
   public String toString() { return "Point" + xyz_; }
}
