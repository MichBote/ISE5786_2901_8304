...
class ShadowTests {
   ...
   /** Produce a picture of a sphere and triangle with spot light and shade. */
   @Test
   ...
   /** Sphere-Triangle shading - move spot even closer. */
   @Test
   ...
   void testTrianglesSphere() {
      ...
      _scene.lights.add(createSpotForTrianglesSphere());
    ...
    */
   private static SpotLight createSpotForTrianglesSphere() {
