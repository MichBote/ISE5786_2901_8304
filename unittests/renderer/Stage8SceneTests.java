   ...
   void testStage8CombinedEffectsScene() {
      ...
      scene.geometries.add(
         new Plane(new Point(0, -80, -250), new Vector(0, 1, 0))
            ...
            .setMaterial(new Material().setKD(0.45).setKS(0.25).setKR(0.35).setShininess(120)),
         new Sphere(new Point(-45, -35, -180), 38)
            .setEmission(new Color(30, 70, 170))
            .setMaterial(new Material().setKD(0.35).setKS(0.45).setKT(0.45).setShininess(160)),
      ...
      scene.lights.add(new SpotLight(new Color(700, 450, 260), new Point(-120, 120, 120), new Vector(1, -1, -2))
         .setKl(0.0005).setKq(0.000001));
      scene.lights.add(new PointLight(new Color(160, 220, 500), new Point(95, 35, 80))
