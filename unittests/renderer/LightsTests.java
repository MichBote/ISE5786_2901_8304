...
class LightsTests {
     ...
     * Position of the light in tests with sphere
     */
    private static final Point SPHERE_LIGHT_DEBUG = new Point(0, 0, 50);
    /**
    ...
    @Disabled
    @SuppressWarnings("java:S109")
    void testSphereSpotDebugSpecular() {
        _scene1.geometries.add(SPHERE);
        _scene1.lights.add(new SpotLight(SPHERE_LIGHT_COLOR, SPHERE_LIGHT_DEBUG, SPHERE_LIGHT_DIRECTION) //
        ...
        _camera1 //
                ...
                .build() //
                .renderImage() //
                .writeToImage("lightSphereSpotDebug");
    }
