...
class CylinderTests {
    ...
    void testFindIntersections() {
        ...
        // On top plane starts on rim -> in (1)
        {
            Cylinder cylinder = createTestCylinder();
        ...
        // On top plane starts on rim -> out (0)
        {
            Cylinder cylinder = createTestCylinder();
            Ray ray = new Ray(new Point(1, 1, 5), new Vector(0, -1, 0));
            var result = cylinder.findIntersections(ray);
        ...
        // Axis from bottom center (1) (t=0 excluded)
        {
            Cylinder cylinder = createTestCylinder();
        ...
        // On bottom plane two rim points (2)
        {
            Cylinder cylinder = createTestCylinder();
